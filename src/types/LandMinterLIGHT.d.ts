...
interface LandMinterLIGHTInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mintLand(uint256)": FunctionFragment;
...
export class LandMinterLIGHT extends BaseContract {
  ...
  interface: LandMinterLIGHTInterface;
  ...
  callStatic: {
    ...
    mintLand(_quantity: BigNumberish, overrides?: CallOverrides): Promise<void>;
